return {
    {
        ...
        config = function()
            ...
            vim.g.go_gopls_enabled = 1           -- Disable gopls in vim-go since we use native LSP
            vim.g.go_code_completion_enabled = 1 -- Disable code completion in vim-go
            vim.g.go_def_mapping_enabled = 1     -- Disable default mapping in vim-go
            vim.g.go_doc_keywordprg_enabled = 1  -- Disable K mapping
