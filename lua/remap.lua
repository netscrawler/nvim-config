...
vim.api.nvim_set_keymap(
	"n",
	"<leader>pc",
	"<cmd>Telescope projectmgr create_project<cr>",
	{ noremap = true, silent = true }
)
vim.api.nvim_set_keymap(
	"n",
	"<leader>pd",
	"<cmd>Telescope projectmgr delete_project<cr>",
	{ noremap = true, silent = true }
)
vim.api.nvim_set_keymap(
	"n",
	"<leader>pr",
	"<cmd>Telescope projectmgr rename_project<cr>",
	{ noremap = true, silent = true }
)
...
vim.keymap.set("n", "<leader>ca", "<cmd>Lspsaga code_action<CR>", { desc = "code_action" })
